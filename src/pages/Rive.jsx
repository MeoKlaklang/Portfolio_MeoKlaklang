    ...
    <div className="rive-container">
      ...
      >
        <motion.div className="rive-card" variants={cardAnim} whileHover={{ scale: 1.03 }}>
          <video
            src={asset("rive-kat.mp4")}
            autoPlay
            loop
            muted
            playsInline
            className="rive-video"
          />
        </motion.div>

        <motion.div className="rive-card" variants={cardAnim} whileHover={{ scale: 1.03 }}>
          <video
            // ⚠️ Best hernoemen naar "rive-kat-2.mp4"
            src={asset("rive kat 2.mp4")}
            autoPlay
            loop
            muted
            playsInline
      ...
      <div className="rive-text-grid">
        <motion.div className="rive-textblock" initial="hidden" whileInView="visible" variants={cardAnim}>
          <h3>Probleem</h3>
          <p>
            Een issue dat ik bij rive had is dat je je files niet kan exporteren
            naar figma of een ander platform omdat dit betalend is.
          </p>
        </motion.div>
