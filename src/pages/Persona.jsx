			...
			<div className="persona-grid">
				...
				>
					...
					<p className="persona-info">
						Kinderopvang medewerkster<br />
						Leeftijd: 30 jaar<br />
						Locatie: Holsbeek
					</p>

					<p className="persona-description">
						Marte is een zorgzame vrouw die haar tijd verdeelt tussen haar werk in de kinderopvang
						en het opvoeden van haar éénjarig kind. Ze houdt van dieren en heeft thuis een kat, maar
						wist tot voor kort weinig over wat een opvanggezin precies doet.
					</p>

					<p className="persona-description">
						Ze zoekt vooral duidelijke en beknopte informatie wanneer ze online opzoekt hoe dit werkt.
					</p>
				</motion.div>
